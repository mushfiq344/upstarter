...
<html lang="en">
    ...
    <head>
        ...
        {{--datatables css--}}
        <link href="{{url('dashboard/plugins/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet"
              type="text/css">
        <link href="{{url('dashboard/plugins/datatables/buttons.bootstrap4.min.css')}}" rel="stylesheet"
              type="text/css"><!-- Responsive datatable examples -->
        <link href="{{url('dashboard/plugins/datatables/responsive.bootstrap4.min.css')}}" rel="stylesheet"
              type="text/css">
    ...
    <body>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    <div class="float-right d-none d-md-block">
                                        <div class="dropdown">
                                            @if($type!='subscribers')
                                                <a href="{{route('upload',['type'=>$type])}}"
                                                   class="btn btn-primary  arrow-none waves-effect waves-light"
                                                   type="button" aria-haspopup="true"
                                                   aria-expanded="false"><i class="mdi mdi-settings mr-2"></i>Upload
                                                </a>
                                            @endif
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{route('upload',['type'=>$type])}}">Upload</a>
        ...
        <!-- Datatable init js -->
        <script src="{{url('dashboard/assets/pages/datatables.init.js')}}"></script><!-- App js -->
